    ...
    for (int ct2 = 0; ct2 < attrCnt; ct2++)
    {
      if (strcmp(schemaAttr[ct1].attrName, attrList[ct2].attrName) == 0)
      {
        ...
        case INTEGER:
          ...
          memcpy((char *)recData + schemaAttr[ct1].attrOffset, (char *)&intVal, schemaAttr[ct1].attrLen);
          break;

        case FLOAT:
          floatVal = atof((char *)attrList[ct2].attrValue);
          memcpy((char *)recData + schemaAttr[ct1].attrOffset, (char *)&floatVal, schemaAttr[ct1].attrLen);
          break;

        default:
          memcpy((char *)recData + schemaAttr[ct1].attrOffset, attrList[ct2].attrValue, schemaAttr[ct1].attrLen);
          break;
        }
      }
    }
